...
<footer class="relative z-10 bg-[#fbef8b] pt-20 pb-10 lg:pt-[120px] lg:pb-20 border-t-8 border-[#b09d72]">
        ...
        <div class="-mx-0 flex flex-wrap  px-4 lg:px-0">
            <div class="w-full px-4  lg:w-3/12 flex flex-col items-center">
                <div class="mb-10 w-full flex flex-col items-center">
                    ...
                    <p class="mb-7 text-base text-black lg:text-justify text-center">
                        ...
                        commune africaine et malgache en janvier 1971.
                    </p>
                </div>
            </div>
