            ...
            <div class="h-[50vh] md:h-[60vh] w-full flex items-center justify-center">
                <div class="w-full h-full text-white bg-gray-700 opacity-80 flex flex-col py-12 lg:py-0 gap-8 justify-center items-center">
                    <div class="flex flex-col items-center px-4 gap-4 text-center">
                        ...
                        <h1 class="text-xl text-center font-bold">Vous souhaitez vous spécialiser dans un domaine précis de l'informatique et obtenir une certification reconnue par les professionnels du secteur ? <br> Notre école d'informatique est là pour vous aider à atteindre vos objectifs !</h1>
                    </div>
            ...
            <div class="container mx-auto px-4 lg:px-0">
                <div class="flex items-start justify-center gap-12">
                    ...
                    <div class="lg:w-1/3 flex flex-col items-center justify-center hover:bg-stone-200 rounded duration-500">
                        <img class="w-full h-[20vh] rounded" src="https://images.unsplash.com/photo-1518770660439-4636190af475?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="formation-image">
                        <div class="p-4 lg:p-6 flex flex-col gap-5 text-center">
                            <h1 class="text-xl lg:text-3xl  text-red-600 font-bold uppercase">Certification CCNA Cisco Sécurity</h1>
                            <p class="text-lg lg:text-xl text-justify text-gray-700 leading-snug">Certification de niveau professionnel qui valide les compétences en matière de sécurité des réseaux informatiques. Elle est reconnue internationalement et est très appréciée par les employeurs dans le domaine de l'informatique et des réseaux.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="lg:w-1/3 flex flex-col items-center justify-center hover:bg-stone-200 rounded duration-500">
                        ...
                        <div class="p-4 lg:p-6 flex flex-col gap-5 text-center">
                            ...
                            <p class="text-xl text-gray-700  text-justify leading-snug">Obtenir cette certification permet de démontrer une solide expertise en informatique et de posséder les compétences nécessaires pour résoudre des problèmes complexes en utilisant des algorithmes et des langages de programmation.
                            </p>
                        </div>
                    </div>

                    <div class="lg:w-1/3 flex flex-col items-center justify-center hover:bg-stone-200 rounded duration-500">
                        <img class="w-full h-[20vh] rounded" src="https://plus.unsplash.com/premium_photo-1661644858773-b02cfddc793a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1169&q=80" alt="formation-image">
                        <div class="p-4 lg:p-6 flex flex-col gap-5 text-center">
                            <h1 class="text-xl lg:text-3xl text-red-600 font-bold uppercase">Certification CCNA Cisco</h1>
                            <p class="text-xl text-gray-700 text-justify leading-snug">Obtenir cette certification permet de démontrer une expertise solide dans la mise en place et la gestion de la sécurité des réseaux informatiques, ainsi que dans l'utilisation des équipements et technologies Cisco en matière de sécurité.
                            </p>
                        </div>
                    </div>
                </div>
