            ...
            <div class="h-[50vh] md:h-[60vh] w-full flex items-center justify-center">
                <div class="w-full h-full text-white bg-gray-700 opacity-80 flex flex-col py-12 lg:py-0 gap-8 justify-center items-center">
                    <div class="flex flex-col items-center px-4 gap-4 text-center">
                        ...
                        <h1 class="text-xl text-center font-bold">Un type de formation qui offre aux étudiants la possibilité d'apprendre les compétences nécessaires pour <br> travailler dans le domaine de l'informatique de manière non traditionnelle.</h1>
                    </div>
            ...
            <div class="container mx-auto px-4 lg:px-0">
                <div class="flex items-start justify-center gap-12">
                    ...
                    <div class="lg:w-1/3 flex flex-col items-center justify-center hover:bg-stone-200 rounded duration-500">
                        <img class="w-full h-[20vh] rounded" src="https://www.efhr.eu/wp-content/uploads/2017/11/media-wall-1600x700_c.jpg" alt="formation-image">
                        <div class="p-4 lg:p-6 flex flex-col gap-5 text-center">
                            ...
                            <p class="text-lg lg:text-xl text-justify text-gray-700 leading-snug">La licence Multimédia est une formation pluridisciplinaire qui allie connaissances théoriques et pratiques. Elle permet aux étudiants de développer leurs compétences en matière de création de contenu multimédia, de développement de sites web, de design graphique, d'animation 3D, de programmation et de bien d'autres domaines encore.
                            </p>
                        </div>
                    </div>

                    <div class="lg:w-1/3 flex flex-col items-center justify-center hover:bg-stone-200 rounded duration-500">
                        <img class="w-full h-[20vh] rounded" src="https://images.pexels.com/photos/546819/pexels-photo-546819.jpeg?auto=compress&cs=tinysrgb&w=600" alt="formation-image">
                        <div class="p-4 lg:p-6 flex flex-col gap-5 text-center">
                            <h1 class="text-xl lg:text-3xl text-red-600 font-bold uppercase">Technologie Web</h1>
                            <p class="text-xl text-gray-700 text-justify leading-snug">La technologie Web est un domaine en constante évolution qui regroupe l'ensemble des technologies utilisées pour développer et mettre en ligne des sites web et des applications web. Il comprend de nombreux langages de programmation tels que HTML, CSS, JavaScript et PHP, ainsi que des frameworks tels que React, Angular et Vue.js.
                            </p>
                        </div>
                    </div>

                    <div class="lg:w-1/3 flex flex-col items-center justify-center hover:bg-stone-200 rounded duration-500">
                        <img class="w-full h-[20vh] rounded" src="https://infosconcourseducation.com/wp-content/uploads/2022/11/depositphotos_533947378-stock-photo-african-graphic-web-designer-using-1.webp" alt="formation-image">
                        <div class="p-4 lg:p-6 flex flex-col gap-5 text-center">
                            <h1 class="text-xl lg:text-3xl text-red-600 font-bold uppercase">Infographie (M-TWI)</h1>
                            <p class="text-xl text-gray-700 text-justify leading-snug">L'infographie (M-TWI) est une formation universitaire qui vise à fournir aux étudiants les compétences nécessaires pour travailler dans le domaine de l'infographie et de la communication visuelle. Elle couvre un large éventail de domaines, tels que la conception graphique, la photographie, la vidéographie, la réalisation de films, la direction artistique et bien d'autres encore.
                            </p>
                        </div>
                    </div>
                </div>
