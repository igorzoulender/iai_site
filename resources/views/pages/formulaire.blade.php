		...
		<div class="max-w-3xl mx-auto px-4 py-10 ">
			...
			<div x-show.transition="step != 'complete'">
				...
				<div class="border-b-2 py-4">
					<div class="uppercase tracking-wide text-xs font-bold text-gray-500 mb-1 leading-tight" x-text="`Page: ${step} sur 4`"></div>
				...
				<div class="py-10">
					<div x-show.transition.in="step === 1">
						<div class="mb-5 text-center">
							...
							<div class="mx-auto w-48 text-gray-500 text-md mt-4 text-center mt-1">Cliquez pour ajouter une photo de profil</div>
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6 mt-8">
                            ...
                            <div class="w-full md:w-1/3 px-3">
                                ...
                                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="pays" type="text" placeholder="pays">
                            </div>
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="langue">
                                    ...
                                    <div class="relative">
                                        <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="langue">
                                            <option>Ewe</option>
                                            <option>Kabyè</option>
                                            <option>minan</option>
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="nom-de-famille" type="text" placeholder="Nationalite">
                            </div>
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="lieu-naissance">
                                    ville de naissance
                                </label>
                                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="lieu-naissance" type="text" placeholder="Lieu de naissance">
                            </div>
                        </div>
					...
					<div x-show.transition.in="step === 2">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6 mt-8">
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                        ...
                                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="e-mail" type="mail" placeholder="monnom@exemple.com">
                            ...
                            <div class="w-full md:w-1/3 px-3">
                                        ...
                                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="numero" type="text" placeholder="numéro de téléphone">
                            </div>
                            <div class="w-full md:w-1/3 px-3">
                                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="lieu">
                                        lieu d'habitation
                                        </label>
                                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="lieu" type="text" placeholder="lieu">
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            ...
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="nom-de-famille" type="text" placeholder="Lieu de naissance">
                            </div>
                        </div>
					</div>
						...
						<div class="mb-6">
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    ...
                                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="e-mail" type="mail" placeholder="e-mail">
                                </div>
                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="numero-telephone">
                                        Numéro de téléphone
                                    </label>
                                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="numero-telephone" type="text" placeholder="numéro de téléphone">
                                </div>
                            </div>
							...
							<div class="flex">
								<label
									...
									<div class="text-teal-600 mr-3">
										<input type="radio" x-model="gender" value="Masculin" class="form-radio focus:outline-none focus:shadow-outline" />
									</div>
								...
								<label
									...
									<div class="text-teal-600 mr-3">
										<input type="radio" x-model="gender" value="Feminin" class="form-radio focus:outline-none focus:shadow-outline" />
									</div>
