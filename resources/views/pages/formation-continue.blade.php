            ...
            <div class="h-[50vh] md:h-[60vh] w-full flex items-center justify-center">
                <div class="w-full h-full text-white bg-gray-700 opacity-80 flex flex-col py-12 lg:py-0 gap-8 justify-center items-center">
                    <div class="flex flex-col items-center px-4 gap-4 text-center">
                        ...
                        <h1 class="text-xl text-center font-bold">Notre objectif avec cette formation est de vous aider à maintenir et à améliorer vos compétences en informatique <br> afin que vous puissiez rester à jour dans un domaine qui évolue rapidement.</h1>
                    </div>
            ...
            <div class="container mx-auto px-4 lg:px-0">
                <div class="flex items-start justify-center gap-12">
                    ...
                    <div class="lg:w-1/3 flex flex-col items-center justify-center hover:bg-stone-200 rounded duration-500">
                        <img class="w-full h-[20vh] rounded" src="https://exploreengineering.ca/sites/default/files/2020-02/NEM_software.jpg" alt="formation-image">
                        <div class="p-4 lg:p-6 flex flex-col gap-5 text-center">
                            ...
                            <p class="text-lg lg:text-xl text-justify text-gray-700 leading-snug">La filière Génie Logiciel forme des informaticiens capables de concevoir et de maintenir des
                                logiciels en s’appuyant sur des méthodes et des outils très évolués. les principaux acquis après
                                une formation en Génie Logiciel sont la maîtrise des systèmes d'information, des outils
                                d'analyse et de modélisation, de programmation dans les langages de pointe ainsi que
                                l'administration des bases de données. A cet effet, l'IAI-TOGO met à la disposition de ses
                                étudiants des centres de calcul équipés de micro-ordinateurs le tout dans un réseau local pour
                                le partage des ressources. La formation est théorique et pratique renforcée par des stages
                                d'entreprise.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="lg:w-1/3 flex flex-col items-center justify-center hover:bg-stone-200 rounded duration-500">
                        <img class="w-full h-[20vh] rounded" src="https://www.adentis.fr/wp-content/uploads/2017/03/Serveurs.jpg" alt="formation-image">
                        <div class="p-4 lg:p-6 flex flex-col gap-5 text-center">
                            <h1 class="text-xl lg:text-3xl text-red-600 font-bold uppercase">Système et Réseaux</h1>
                            <p class="text-xl text-gray-700 text-justify leading-snug">La filière Systèmes et Réseaux, créée il y a deux ans forme des informaticiens capables de
                                concevoir, implanter, interconnecter et administrer des réseaux informatiques et d'assurer
                                également la maintenance de tout matériel informatique. L'accent est donc mis sur l'étude des
                                réseaux sous la norme CISCO CCNA, les systèmes d'exploitation, l'électricité, l'électronique
                                et la maintenance.
                                A cet effet, l'IAI-TOGO met à la disposition de ses étudiants des salles de réseaux équipées de
                                micro-ordinateurs le tout dans un réseau local pour le partage des ressources.
                                La formation est très pratique. La première promotion de sept (7) étudiants ont reçu leur
                                diplôme en 2010.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="lg:w-1/3 flex flex-col items-center justify-center hover:bg-stone-200 rounded duration-500">
                        <img class="w-full h-[20vh] rounded" src="https://www.letudiant.fr/uploads/mediatheque/ETU_ETU/3/7/2534737-but-mmi-metiers-du-multimedia-et-de-l-internet-original.jpg" alt="formation-image">
                        <div class="p-4 lg:p-6 flex flex-col gap-5 text-center">
                            <h1 class="text-xl lg:text-3xl text-red-600 font-bold uppercase">Multimédia</h1>
                            <p class="text-xl text-gray-700 text-justify leading-snug">La licence Multimédia, Technologie Web et Infographie (M-TWI), vise à apporter aux
                                étudiants les compétences nécessaires pour réussir leur projet, qu’il soit de création,
                                d’administration ou d’industrialisation des produits de communication audiovisuelle.
                                L’identité de la formation est liée à la nature pluridisciplinaire des enseignements
                                (connaissance technologiques, informatique, gestion de projet, création audiovisuelle,
                                infographie) et à l’opportunité d’affirmer une bonne communication via des documents
                                multimédias. Il s’agit aussi d’intégrer une culture de management de projets multimédia et
                                infographie.
